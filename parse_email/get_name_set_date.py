...
#for fichier in files:
fichier = '0000000920-rectificatif semaine du 03.06 au 09.06 pour christophe g et humberto.eml'
print(fichier)
m = Objet_mail(fichier)
print(m.getAttachmentCount())
print(m.getAllAttachmentFilenames())
print(m.getNormalizedName())
#AttributeError: 'Objet_mail' object has no attribute 'liste_noms_fichiers_pieces_jointes'
